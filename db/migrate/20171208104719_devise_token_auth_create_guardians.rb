...
class DeviseTokenAuthCreateGuardians < ActiveRecord::Migration[5.1]
  def change # rubocop:disable Metrics/AbcSize,MethodLength
    ...
    add_index :guardians, %i[uid provider], unique: true
