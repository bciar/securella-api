...
ActiveRecord::Schema.define(version: 20180119132127) do
  ...
  create_table "alarm_delegations", force: :cascade do |t|
    t.integer "alarm_id"
  ...
  create_table "alarm_requests", force: :cascade do |t|
    t.integer "alarm_id"
  ...
  create_table "guardian_locations", force: :cascade do |t|
    t.integer "guardian_id"
    t.float "latitude"
    t.float "longitude"
    t.datetime "created_at", null: false
  ...
  create_table "guardians", force: :cascade do |t|
    ...
    t.index ["uid", "provider"], name: "index_guardians_on_uid_and_provider", unique: true
  end
